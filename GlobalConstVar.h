...
using namespace std;
const int N_LAT=3, N_Band=10, N_Com = 2, N_En_Pr = 74, Nkp = 200, Nkp2 = 400, MAX_IT = 400, N_En = 200, N_point = 3, N_Alpha = 3, n_Cores = 6;
...
extern Doub (*r)[3][3];
extern Doub (*R)[3];
extern Doub(*translationVectors)[3];
